% NameFile: MAIN_state_to_RestMotion
...
%%%%% STATE-To-REST %%%%%
[time, position, velocity, acceleration, jerk, snap, crackle, pop] = Reversed_stateToRestMotion(totalTime, accelerationValue, initialVelocity, initialPosition, constantVelocity, accelerationTime, coastingTime)